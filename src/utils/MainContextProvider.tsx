...
import {
  ...
  WORM_USDT_MARKET,
  WORM_MARKET_BASE,
} from "../../swap-ui/utils/pubkeys";
import {
  useTokenMap,
  useTokenListContext,
} from "../../swap-ui/context/TokenList";
import {
  fetchSolletInfo,
  requestWormholeSwapMarketIfNeeded,
} from "../../swap-ui/context/Sollet";
import { setMintCache } from "../../swap-ui/context/Token";
...
const MainDexComponent = React.createContext<DexContext | null>(null);

export function MainDexProvider(props: any) {
...
export function useDexContext(): DexContext {
  const ctx = useContext(MainDexComponent);
  if (ctx === null) {
...
export function useOpenMainOrders(): Map<string, Array<OpenOrders>> {
