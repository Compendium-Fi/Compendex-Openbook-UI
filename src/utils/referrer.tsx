...
const REACT_APP_USDT_REFERRAL_FEES_ADDRESS = process.env.NEXT_PUBLIC_USDT_REFERRAL;
const REACT_APP_USDC_REFERRAL_FEES_ADDRESS = process.env.NEXT_PUBLIC_USDC_REFERRAL;
      ...
      if (!refCode) {
        setUsdc(
          REACT_APP_USDC_REFERRAL_FEES_ADDRESS
            ? new PublicKey(REACT_APP_USDC_REFERRAL_FEES_ADDRESS)
            : undefined
        );
        setUsdt(
          REACT_APP_USDT_REFERRAL_FEES_ADDRESS
            ? new PublicKey(REACT_APP_USDT_REFERRAL_FEES_ADDRESS)
            : undefined
        );
        return;
      }
